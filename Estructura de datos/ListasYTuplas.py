...
# Los que hayan visto java, C++ lo familiarizaran con los array y la verdad si, son bastantes similares
# PERO SON DIFERENTES, los array almacenan tan solo un tipo de dato, mientras que las listas y tuplas
# pueden almacenar varios tipos de datos dentro de estas estructuras de datos
