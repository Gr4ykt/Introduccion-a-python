...
print("El valor ingresado es", a) # esto nos imprimira el valor ingresado

# asi como puedes imprimir, puedes calcular, convertir, etc a traves de un input, todo esta al alcance de tu imaginacion y logica
